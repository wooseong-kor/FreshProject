        ...
        <form action="./memberAdd.do" method="post" onsubmit="return check()">
            ...
            <div class="join_content">
                ...
                <div class="row_group">
            		<!-- 아이디 -->    
                    <div class="join_row">
                        <h5 class="join_title"><label for="id">아이디 <img src="./image/star.gif" alt="필수" /></label></h5>
                    ...
                    <div class="join_row">
                        ...
                        <h5 class="join_title"><label for="pswd2">비밀번호 재확인 <img src="./image/star.gif" alt="필수" /></label></h5>
                    ...
                    <!-- 이름 -->
                    <div class="join_row">
                        <h5 class="join_title"><label for="name">이름 <img src="./image/star.gif" alt="필수" /></label></h5>
					...
					<!-- 이메일 -->
                    <div class="join_row">
                        <h5 class="join_title"><label for="email">이메일 <img src="./image/star.gif" alt="필수" /></label></h5>
	                ...
	                <div class="join_row" id="mobDiv">
	                    <h5 class="join_title"><label for="phone2">휴대전화
